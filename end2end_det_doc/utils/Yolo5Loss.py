...
class Yolo5Loss:
    ...
    # Compute losses
    def __init__(self, device, hyp, strides, na, num_classes, nl, anchors, autobalance=False, **kwargs):
        ...
        self.anchors = anchors.clone().detach().to(device)  # 原来的anchor不是 gpu   改为gpu
        self.device = device
