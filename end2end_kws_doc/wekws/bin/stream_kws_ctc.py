...
# onnx_session = onnxruntime.InferenceSession("dstcn.onnx")
...
class KeyWordSpotter(torch.nn.Module):
    def __init__(self, ckpt_path, config_path, token_path, lexicon_path,
        ...
        self.wave_remained = np.zeros((320,))
        ...
        self.in_cache = torch.zeros(1, 256, 105, dtype=torch.float)
