...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_config',
                        # default='/mnt/wekws-main/examples/speechcommand_v1/s0/conf/ds_tcn.yaml',
                        help='training yaml conf')
    parser.add_argument('--in_scp', help='wav scp file')
    parser.add_argument('--out_cmvn',
                        # default='/mnt/wekws-main/speech_commands_v1/data/train/global_cmvn',
